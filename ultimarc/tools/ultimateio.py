...
class UltimateIOClass(object):
    ...
    def run(self):
        ...
        # Set ultimateIO device configuration from a configuration file
...
def run():
    ...
    group.add_argument('--get-config', help=_('Get ultimateIO device config'), default=False, action='store_true')
    ...
    group.add_argument('--set-config', help=_('Set ultimateIO device config from config file'), type=str, default=None,
                       metavar='CONFIG-FILE')
