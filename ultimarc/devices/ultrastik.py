...
USTIK_PRE_CONFIG_MESG_LENGTH = 32

# UltraStik 2015 and newer defines
USTIK_INTERFACE = 2
USTIK_CONFIG_MESG_LENGTH = 4
...
class UltraStikPre2015Device(USBDeviceHandle):
    ...
    def set_controller_id(self, new_controller_id: int) -> bool:
        ...
        # Setup data array.
        data = (ct.c_uint8 * USTIK_PRE_CONFIG_MESG_LENGTH)(0)
        data[0] = new_id
        ...
        resp_2 = self.write(USBRequestCode.ULTRASTIK_EB, 0x0, USTIK_PRE_INTERFACE, data, USTIK_PRE_CONFIG_MESG_LENGTH,
                           request_type=USBRequestType.REQUEST_TYPE_VENDOR,
                           recipient=USBRequestRecipient.RECIPIENT_OTHER)
...
class UltraStikDevice(USBDeviceHandle):
    ...
    def set_controller_id(self, new_controller_id: int) -> bool:
        ...
        new_id = USTIK_CONFIG_BASE + (new_controller_id - 1)
        # Setup data array.
        data = (ct.c_uint8 * USTIK_CONFIG_MESG_LENGTH)(0)
        data[0] = new_id

        resp = self.write(USBRequestCode.SET_CONFIGURATION, 0x0, USTIK_INTERFACE, data, USTIK_CONFIG_MESG_LENGTH,
